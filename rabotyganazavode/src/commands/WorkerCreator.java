...
// утилитный класс для создания Worker через интерактивный ввод
// Нужен, чтобы InsertCommand or UpdateCommand  не дублировали один и тот же код запроса полей.
public class WorkerCreator {


      // Создает объект Worker, запрашивая данные у пользователя через InputManager.
    public static Worker createWorker(InputManager inputManager) throws OperationCancelledException, InvalidCommandArgumentsException {
        // Ввод имени
